...
if(!JSON.stringify(G.prerequisites.white).includes('stellar_recombination'))fail('Anã Branca deve esperar a sequência de plasma');
if(!campaign.includes('version:15')||!campaign.includes("activeId='stellar_movement'")||!campaign.includes("activeId='solar_wind'"))fail('Migrações de Movimentação/plasma ausentes');
