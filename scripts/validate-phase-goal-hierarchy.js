...
for(const token of [
 "first_nebulae:'PRIMEIRAS NEBULOSAS'","he_orange:'ANÃ LARANJA'","c:'TRIPLO-ALFA'",
...
for(const token of [
 "base='Reúna Hidrogênio'","base='Forme Hélio-4'","base='Forme Hélio-3'","base='Produza Lítio-7'",
...
console.log('Phase goal hierarchy OK: compact one-line objective, contextual identity, recipe-only box, menu/map naming.');
