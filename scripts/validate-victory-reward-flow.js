...
console.log('P1 victory reward contract OK: P0 save/completion stays canonical, reward owns the interstitial, the phase menu Map action calls the reward map API directly, branches defer to the map and unique next phases reuse the canonical launcher.');
