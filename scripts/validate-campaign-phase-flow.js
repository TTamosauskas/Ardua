...
const must=["$('goalText').textContent='Leve o Hélio até o núcleo estelar.'","if(s.mode==='movementTutorial')return count(objectiveSatisfied(s)?1:0,s.target||1)","Clique no átomo e avance um espaço por vez","window.dispatchEvent(new CustomEvent('ardua:phase-ended'","function phaseEndButtonLabel(s=phase())"];
