...
const prologue=uniq(['bigbang','primordial_d','primordial_t','primordial_he3','primordial_he3d','primordial_td',...seq('atomic'),...seq('molecular'),...seq('brown')]);
const first=uniq(['first_generation_formation',...seq('red'),...seq('mid'),...seq('high'),...seq('collapse'),'nu_f','first_enrichment']);
...
const defs=Object.freeze({
 prologue:Object.freeze({id:'prologue',title:'Universo Primordial',short:'Prólogo',description:'A matéria-prima cósmica surge antes das estrelas.',birthSymbols:Object.freeze([]),productionSummary:'H, He e Li surgem antes das gerações estelares; o prólogo termina com protoestrelas e a demonstração de uma anã marrom.',members:Object.freeze(expand(prologue))}),
